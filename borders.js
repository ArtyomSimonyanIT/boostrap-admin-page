...
document.getElementById('customUtilites').style.display = 'block';
document.getElementById('customUtilites').style.height = '14.8vw';
document.getElementById('customUtilites').style.paddingBottom = '1vw';

...
document.getElementById('customComponents').style.display = 'block';
document.getElementById('customComponents').style.height = '8.4vw';
document.getElementById('customComponents').style.paddingBottom = '1vw';

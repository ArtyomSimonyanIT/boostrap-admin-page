...
window.onload = function () {
    document.body.addEventListener('click', () => {
        ...
        if (document.getElementById('dropdownHeader').style.display == 'block') {
            if (dropdownClose) {
                let drop = document.getElementById('dropdownHeader');
                drop.style.opacity = 0;
                let dropdownCloseST = setTimeout(() => {
                    document.getElementById('dropdownHeader').style.display = 'none';
                    dropdownClose = false;
                    clearInterval(dropdownCloseST)
                }, 300)
            }
            dropdownClose = true;
        }
        if (document.getElementById('dropdownHeader2').style.display == 'block') {
            if (dropdownClose) {
                let drop = document.getElementById('dropdownHeader2');
                drop.style.opacity = 0;
                let dropdownCloseST = setTimeout(() => {
                    document.getElementById('dropdownHeader2').style.display = 'none';
                    dropdownClose = false;
                    clearInterval(dropdownCloseST)
                }, 300)
            }
